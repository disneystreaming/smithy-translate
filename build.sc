...
object Deps {
  object alloy {
    val core =
      ivy"com.disneystreaming.alloy:alloy-core:0.1.17-DIRTY3e3bf7d8"
  }
  object circe {
  ...
  object swagger {
    val parser = Agg(
      ivy"io.swagger.parser.v3:swagger-parser:2.1.13",
  ...
  val coursier = ivy"io.get-coursier::coursier:2.1.1"
}
