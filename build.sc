...
object Deps {
  object alloy {
    val core = ivy"com.disneystreaming.alloy:alloy-core:0.1.11"
  }
  object circe {
  ...
  val slf4j =
    ivy"org.slf4j:slf4j-nop:2.0.6" // needed since swagger-parser relies on slf4j-api
  object swagger {
    val parser = Agg(
      ivy"io.swagger.parser.v3:swagger-parser:2.1.11",
